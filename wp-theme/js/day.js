...
const SHOW_DETAILS_MS = 100
const RESET_MS = 520
const HOVER_SOUND_GAP_MS = 240

const rootDir = document.querySelector('.tarot-ritual__rootdir').textContent

const BACKGROUND_AUDIO_SOURCES = [`${rootDir}/assets/audio/background.mp3`]
const ACTION_AUDIO_SOURCES = [`${rootDir}/assets/audio/action.mp3`]
