    ...
    <div class="offer__w">
      <div class="offer__left">
        ...
        <div class="offer__text-mobile">
          <p class="text-2">Каждая колода Ezotouch — это отдельный мир со своей энергией и историей</p>
          <p class="text-2 opa-5">Каждая карта продумана до мелочей, она хранит свой смысл и помогает увидеть ответы
            на любые вопросы</p>
        </div>
        <div class="offer__action">
          <a class="btn btn btn-primary" href="<?php echo esc_url( home_url( '/deck-type/taro' ) ); ?>"><span>Выбрать колоду Таро</span><span
              class="bg"></span></a>
          <a class="btn btn" href="<?php echo esc_url( home_url( '/deck-type/mak' ) ); ?>"><span>Выбрать колоду МАК</span><span class="bg"></span></a>
        </div>
      </div>
        ...
        <div class="taro__left">
          <div class="taro__list">
            <div class="taro-card">
              ...
              <p class="taro-card__text">Это диалог с собой через визуальные образы.<span class="opa-6">Карты помогают
                  найти ответы на вопросы, которые вас так волнуют</span></p>
            </div>
            <div class="taro-card">
              <img srcset="<?php bloginfo('template_directory'); ?>/assets/images/star-50x55.png 50w"
                src="<?php bloginfo('template_directory'); ?>/assets/images/star-50x55.png"
            ...
            <div class="taro-card">
              <img srcset="<?php bloginfo('template_directory'); ?>/assets/images/star-50x55.png 50w"
                ...
                sizes="(min-width: 50px) 50px, 100vw" width="50" height="55" alt decoding="async" loading="lazy"
                class="taro-card__img">
              <p class="taro-card__text">Это способ поиска опоры и решений<span class="opa-6">Карты используют не для предсказаний, а для выбора направления и конкретных шагов</span></p>
            </div>
          </div>
          <a class="btn btn btn-primary taro__btn" href="<?php echo esc_url( home_url( '/deck-type/taro' ) ); ?>"><span>Перейти в Библиотеку Таро</span><span
              class="bg"></span></a>
        </div>
        <img
            ...
            <div class="taro-read__bottom">
              <div class="taro-read__point">
                ...
                <p class="text-2 opa-5">Для начала рекомендуется выбрать классическую колоду, например, Таро
                  Райдера-Уэйта, так как большинство учебных материалов и значений карт основаны именно на ней.</p>
              </div>
              <div class="taro-read__point">
                <h5 class="text-2 opa-8">Изучение значений</h5>
                <p class="text-2 opa-5">Каждая из 78 карт (Арканов) имеет свое уникальное значение. Важно изучить как
                  Старшие (22), так и Младшие Арканы (56). Можно начать с изучения нескольких карт или мастей,
                  постепенно расширяя знания.</p>
              </div>
              <div class="taro-read__point">
                ...
                <p class="text-2 opa-5">Помимо заучивания значений, ключевым аспектом является ваша личная интерпретация
                  символов и образов, которые вы видите на картах. Практика помогает развить эту интуицию.</p>
              </div>
				<div class="taro-read__point">
              <h5 class="text-2 opa-8">Подготовка</h5>
              <p class="text-2 opa-5">Подготовка: перед сеансом важно очистить разум, сфокусироваться на своем вопросе и
                создать спокойную атмосферу. </p>
            </div>
            </div>
        ...
        <div class="taro-read__card">
          ...
          <div class="taro-read__content">
            ...
            <div class="taro-read__bottom">
              <div class="taro-read__point">
                <h5 class="text-2 opa-8">Выбор колоды</h5>
                <p class="text-2 opa-5">ДДля новичков отлично подходят простые расклады, например, на трех картах
                  (прошлое/настоящее/будущее, ситуация/действие/результат).</p>
              </div>
              <div class="taro-read__point">
                <h5 class="text-2 opa-8">Формулировка вопроса</h5>
                <p class="text-2 opa-5">Четко и ясно сформулируйте вопрос, на который вы хотите получить ответ. От этого
                  зависит точность толкования.</p>
              </div>
              <div class="taro-read__point">
                <h5 class="text-2 opa-8">Перемешивание карт</h5>
                <p class="text-2 opa-5">Тщательно перемешайте колоду, держа в уме свой вопрос. Затем вытащите карты в соответствии с выбранной схемой расклада.</p>
              </div>
              <div class="taro-read__point">
                <h5 class="text-2 opa-8">Толкование</h5>
                <p class="text-2 opa-5">Разложите карты (обычно рубашкой вверх, затем переворачивая) и интерпретируйте
                  их значения в контексте заданного вопроса и позиций в раскладе.</p>
              </div>
            </div>
          </div>
        </div>
  ...
  <section class="list-cards gsap-smooth" aria-labelledby="list-cards-title">
    <div class="container">
      <div class="section-top taro-cards-top">
        ...
        <div class="section-top__right">
          <p class="section-top__text text-2">Каждая колода состоит из 78 карт —<!-- --> <span
              class="opa-5">классический формат, принятый в системе Таро Райдера-Уэйта</span></p>
          <a class="btn btn-primary section-top__btn" href="<?php echo esc_url( home_url( '/deck-type/taro' ) ); ?>"><span>Посмотреть другие колоды</span><span
              class="bg"></span></a>
        </div>
      </div>
      ...
      <a class="btn btn-primary list-cards__btn" href="<?php echo esc_url( home_url( '/deck-type/taro' ) ); ?>"><span>Посмотреть другие колоды</span><span
          class="bg"></span></a>
    </div>
  </section>
  <section class="mak gsap-smooth" aria-labelledby="mak-title">
    <div class="container">
      <div class="mak__top">
        ...
        <p class="mak__text opa-8 big-text-l">Вытяните карту — и пусть её образ станет зеркалом для ваших мыслей и
          чувств</p>
        <p class="mak__text opa-8 big-text-l">Простой способ увидеть своё состояние со стороны, найти ясность и
          внутреннюю опору</p>
      </div>
      <img
      ...
      <div class="mak-read__w">
        ...
        <div class="mak-read-card">
          ...
          <div class="mak-read-card__bottom">
            ...
            <div class="mak-read-card__cont">
              <div class="mak-read-card__w">
                <h5>"Вслепую" (взакрытую)</h5>
                <p>Вытащите карту из колоды, не глядя на изображение. Этот способ часто используется для получения
                  неожиданных ответов от подсознания.</p>
              </div>
              <div class="mak-read-card__w">
                <h5>"В открытую"</h5>
                <p>Просмотрите колоду и выберите изображение, которое "цепляет" вас больше всего, вызывает эмоциональный
                  отклик или кажется наиболее подходящим к вашему вопросу.</p>
              </div>
            </div>
          </div>
        </div>
  ...
  <section class="list-cards gsap-smooth" aria-labelledby="list-cards-title">
    <div class="container">
      <div class="section-top mak-cards-top">
        ...
        <div class="section-top__right">
          <p class="section-top__text text-2">Метафорические карты используются для работы<!-- --> <span class="opa-6">с
              чувствами, мыслями и внутренними состояниями через образы</span></p>
          <a class="btn btn-primary section-top__btn" href="<?php echo esc_url( home_url( '/deck-type/mak' ) ); ?>"><span>Посмотреть другие колоды</span><span
              class="bg"></span></a>
        </div>
      </div>
      <div class="list-cards__w">
      ...
      <a class="btn btn-primary list-cards__btn" href="<?php echo esc_url( home_url( '/deck-type/mak' ) ); ?>"><span>Посмотреть другие колоды</span><span
          class="bg"></span></a>
    </div>
  </section>
